...
const TeamTable = ({ data, changeHandler, options }: TablePropsInterface) => {
  ...
  const passRequiredElement = (
    ...
    currentData: TeamTableRowInterface[]
  ...
  return (
    <div className={styles.mainTableContainer}>
      <div className={styles.infoContainer}>
        <div className={styles.tableHeading}>Team Table</div>
        <div className={styles.addUserBtnContainer}>
          <button
            className={styles.addUserBtn}
            onClick={(e) => setShowUserInfoInput(!showUserInfoInput)}
          >
            Add User
          </button>
          {showUserInfoInput ? (
            <UserInfoForm
              ...
              close={() => setShowUserInfoInput(false)}
            />
          ) : (
            <div></div>
          )}
